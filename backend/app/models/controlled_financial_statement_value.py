...
class ControlledFinancialStatementValue(Base):
    ...
    currency_2025: Mapped[str] = mapped_column(String(16), nullable=False)
    unit_2025: Mapped[str] = mapped_column(String(64), nullable=False)
    scale_2025: Mapped[str] = mapped_column(String(32), nullable=False)
    currency_2024: Mapped[str] = mapped_column(String(16), nullable=False)
    unit_2024: Mapped[str] = mapped_column(String(64), nullable=False)
    scale_2024: Mapped[str] = mapped_column(String(32), nullable=False)
